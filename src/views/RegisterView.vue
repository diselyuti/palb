          ...
          <div>
            ...
            <div class="mt-2">
              <input
                ...
                autocomplete="email"
                required
                class="appearance-none block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
...
const schema = yup.object({
  ...
  confirmPassword: yup
    ...
    .oneOf([yup.ref('password'), "Passwords don't match"], 'Паролі не співпадають')
})
